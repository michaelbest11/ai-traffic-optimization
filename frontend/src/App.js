...
import { accraIntersections, accraRoutes } from "./data/accraData";
import { kumasiIntersections, kumasiRoutes } from "./data/kumasiData";
// Import MapView from the separate file
